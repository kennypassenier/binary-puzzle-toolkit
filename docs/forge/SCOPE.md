...
- **G8 · Performance.** Repeatable benchmark on Kenny's PC. *(D3)*
  ...
  > **Amendment 2026-08-12 (Phase 4, AR25).** The original figures — one
  ...
  > strategy AR23 rejects; the tier-ceiling carve keeps more clues and

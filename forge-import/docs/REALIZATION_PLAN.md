...
| L1 · Geometry model + inspect | K4, M6, AR3b, AR13.4, AR13.5 | **built + reviewed, gate pending (AFK)** |
...
| L5 · Output, batches, CLI | K7, K8, K10, M2, M4, M7, AR8, AR10, AR11 | atomic write layer built early (AR8, AR10); rest not started |
